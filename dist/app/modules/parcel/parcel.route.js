...
router.patch("/admin/status/:id", (0, validationRequest_1.validationRequest)(parcel_validation_1.updateParcelStatusByAdminZodSchema), (0, checkAuth_1.checkAuth)(user_interface_1.Role.admin), parcel_controller_1.ParcelController.updateParcelStatusByAdmin);
